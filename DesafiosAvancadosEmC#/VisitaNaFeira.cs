...
ser lidos e armazenados nas variáveis A (pimentões amarelos) e B (pimentões vermelhos). 
...
class minhaClasse
{
    ...
    { 
      string [] sacola = Console.ReadLine().Split();
      int a, b, x;
      
      a = Convert.ToInt32(sacola[0]);
      b = Convert.ToInt32(sacola[1]);
